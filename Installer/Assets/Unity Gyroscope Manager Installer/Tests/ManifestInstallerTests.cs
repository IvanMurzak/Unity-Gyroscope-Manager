...
namespace extensions.unity.gyroscope.manager.Installer.Tests
{
    public class ManifestInstallerTests
    {
        ...
        const string FilesRoot = "Assets/Unity Gyroscope Manager Installer/Tests/Files";
        const string FilesCopyRoot = "Temp/Unity Gyroscope Manager Installer/Tests/Files";

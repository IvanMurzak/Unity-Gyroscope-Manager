...
using extensions.unity.gyroscope.manager.Installer.SimpleJSON;

namespace extensions.unity.gyroscope.manager.Installer.Tests
{
    public class VersionComparisonTests
    {
        const string TestManifestPath = "Temp/extensions.unity.gyroscope.manager.Installer.Tests/test_manifest.json";
        const string PackageId = "extensions.unity.gyroscope.manager";

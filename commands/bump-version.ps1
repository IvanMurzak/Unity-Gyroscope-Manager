...
$VersionFiles = @(
    ...
    @{
        Path        = "Installer/Assets/Unity Gyroscope Manager Installer/Installer.cs"
    ...
    @{
        ...
        Pattern     = "https://github\.com/IvanMurzak/Unity-Gyroscope-Manager/releases/download/[\d\.]+/Unity-Gyroscope-Manager-Installer\.unitypackage"
        Replace     = "https://github.com/IvanMurzak/Unity-Gyroscope-Manager/releases/download/{VERSION}/Unity-Gyroscope-Manager-Installer.unitypackage"
